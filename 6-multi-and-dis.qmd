...
Starting with version 1.23.0, **netdiffuseR** supports simulating multi- and dis-adoption diffusion processes.
...
The disadoption feature included in **netdiffuseR** version 1.23.0 opened a new way of studying network diffusion processes ([Lehmann 2017](https://doi.org/10.1007/s13162-017-0093-8), [Alipour 2024](https://doi.org/10.1093/pnasnexus/pgae428)).
