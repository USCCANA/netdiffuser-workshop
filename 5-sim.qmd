...
(<a href="files/sim-solutions-1.R" target="_blank">solution script</a> and <a href="files/sim-solutions-1.pdf" target="_blank">solution plot</a>)
    
2.  Given the following types of networks: Small-world, Scale-free, Bernoulli,
    what set of $n$ initiators maximizes diffusion?
    (<a href="files/sim-solutions-2.r" target="_blank">solution script</a> and <a href="files/sim-solutions-2.pdf" target="_blank">solution plot</a>)
