...
1.  Will have 500 vertices,
2.  Will span 10 time periods,
...
Here we compare a **simple (disease-like) diffusion**, where a single adopting
neighbor is enough to adopt (threshold $= 1$), against the **threshold
diffusion** we simulated above in `diffnet_behavior` (thresholds uniformly
distributed in $[0.3, 0.7]$).
