...
## diffnet from survey_to_diffnet()

We can select a specific village and visualize its diffusion dynamics:

```{r kfamily-village-21, warnings=FALSE, messages=FALSE}
data(kfamily)

kfamily_21 <- subset(kfamily, village %in% c(21))
